...
public class Login2 extends JFrame implements ActionListener {
	...
	public Login2() {
		...
		icon = new ImageIcon(getClass().getResource("Storage/Login2i2.png"));
		...
		jLabel2.setFont(new Font("Cambria",Font.BOLD,25));
		jLabel2.setForeground(Color.white);
		iconLabel.add(jLabel2);
		
		Button1 = new JButton("        BUS",new ImageIcon(getClass().getResource("Storage/bus111.png")));
		...
		Button2 = new JButton("LAUNCH",new ImageIcon(getClass().getResource("Storage/Launch111.png")));
		Button2.setBounds(70,265,180,30);
		Button2.setFont(new Font("Rockwell",Font.BOLD,20));
		Button2.setFocusable(false);
		iconLabel.add(Button2);
		
		Button3 = new JButton("          AIR",new ImageIcon(getClass().getResource("Storage/plane111.png")));
