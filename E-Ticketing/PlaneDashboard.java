...
public class PlaneDashboard extends JFrame implements ActionListener {
	...
	public PlaneDashboard() {
		...
		this.getContentPane().setBackground(Color.decode("#5271ff"));
		...
		icon = new ImageIcon(getClass().getResource("Storage/plane1.png"));
		iconLabel = new JLabel(icon);
		iconLabel.setBounds(-30, -100, icon.getIconWidth(), icon.getIconHeight());
		...
		backButton.setBackground(Color.decode("#5271ff"));
