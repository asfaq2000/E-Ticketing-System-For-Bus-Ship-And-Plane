...
public class BusDashboard extends JFrame implements ActionListener {
	...
	public BusDashboard() {
		...
		this.getContentPane().setBackground(Color.decode("#0a3078"));
		...
		icon = new ImageIcon(getClass().getResource("Storage/Bus11.png"));
		iconLabel = new JLabel(icon);
		iconLabel.setBounds(0, -105, icon.getIconWidth(), icon.getIconHeight());
		iconPanel.add(iconLabel);

		jLabel1 = new JLabel("WHERE WOULD YOU");
		jLabel1.setBounds(67, 50, 250, 30);
		jLabel1.setFont(new Font("Cambria", Font.PLAIN, 22));
		...
		String[] from = { "Departure", "Dhaka", "Naogaon", "Rajshahi", "Rangpur" };
		...
		String[] from2 = { "Arrival", "Dhaka", "Naogaon", "Rajshahi", "Rangpur" };
		...
		String[] coach = { "Shah Fateh Ali", "Shyamoli", "SR Enterprise", "Desh Travel", "Hanif", "GreenLine" };
		...
		backButton.setBackground(Color.decode("#0a3078"));
			...
			if (jComboBox.getSelectedIndex() == 0 && jComboBox2.getSelectedIndex() == 0) {
				...
				try {
					...
					if (jComboBox4.getSelectedIndex() == 0) {
						...
						cost4 = 300 * cost3; //Per person 300 for AC
					}
					totalCost = cost2 + cost4;

					File file = new File("Data/BusData.txt");
					if (!file.exists()) {
