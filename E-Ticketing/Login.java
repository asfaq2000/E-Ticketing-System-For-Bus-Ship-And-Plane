...
public class Login extends JFrame implements ActionListener {
	...
	Login() {
		...
		Font headerText = new Font("Cambria", Font.BOLD, 35);
		...
		loginPageText = new JLabel("  User Log-in");
		loginPageText.setBounds(530, 70, 210, 50);
		loginPageText.setFont(new Font("Cambria", Font.BOLD, 30));
		loginPageText.setForeground(Color.magenta);
		loginPageText.setBorder(BorderFactory.createMatteBorder(0, 0, 2, 0, Color.magenta));
		...
		loginPageImg.setIcon(new ImageIcon("Storage/LogInUI.png"));
		...
		Loginframe.setTitle("Ticket Lagbe?");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == loginB) {
            ...
            String file = "Data/RegistrationInfo.txt";
