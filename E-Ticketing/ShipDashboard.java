...
public class ShipDashboard extends JFrame implements ActionListener {
	...
	public ShipDashboard() {
		...
		this.getContentPane().setBackground(Color.decode("#6095a4"));
		...
		icon = new ImageIcon(getClass().getResource("Storage/Launch1.png"));
		iconLabel = new JLabel(icon);
		iconLabel.setBounds(0, -100, icon.getIconWidth(), icon.getIconHeight());
		...
		String[] from = { "Departure", "Dhaka", "Chandpur", "Vola", "Barishal" };
		...
		String[] from2 = { "Arrival","Dhaka", "Chandpur", "Vola", "Barishal" };
		...
		backButton.setBackground(Color.decode("#6095a4"));
		...
		if (e.getSource() == jButton3) {
			...
			if (jComboBox.getSelectedIndex() == 0 && jComboBox2.getSelectedIndex() == 0) {
				...
				try {
					...
					File file = new File("Data/ShipDetails.txt");
					if (!file.exists()) {
